...
cookbook 'promet_nagios', '= 0.2.0', git: 'git@github.com:promet/promet_nagios'
cookbook 'promet-tools', '~>0.2', github: 'promet/promet-tools'
cookbook 'promet_users', '= 0.1.1', git: 'git@github.com:promet/promet_users'
...
cookbook 'omnibus_updater', '~>1.0', github: 'hw-cookbooks/omnibus_updater'
cookbook 'cronapt', '~>0.3', github: 'promet/cronapt-cookbook'
