...
when "debian"
  ...
  default['php']['apc']['apc.rfc1867']		= 1
  default['php']['apc']['apc.enabled']		= 1 
  default['php']['apc']['apc.shm_segments']	= 1
  default['php']['apc']['apc.ttl']		= 3600
  default['php']['apc']['apc.user_ttl']		= 3600
  default['php']['apc']['apc.num_files_hint']	= 1024
  default['php']['apc']['apc.enable_cli']	= 1
when "suse"
  default['php']['conf_dir']      = '/etc/php5/cli'
  default['php']['ext_conf_dir']  = '/etc/php5/conf.d'
